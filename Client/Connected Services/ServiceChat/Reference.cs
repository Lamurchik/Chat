...
namespace Client.ServiceChat {
    ...
    public interface IServiceChat {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceChat/Connect", ReplyAction="http://tempuri.org/IServiceChat/ConnectResponse")]
        System.Threading.Tasks.Task<int> ConnectAsync(string name, string pasword);
        ...
        string[] GetChatHistory(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceChat/GetChatHistory", ReplyAction="http://tempuri.org/IServiceChat/GetChatHistoryResponse")]
        System.Threading.Tasks.Task<string[]> GetChatHistoryAsync(int id);
    ...
    public partial class ServiceChatClient : System.ServiceModel.DuplexClientBase<Client.ServiceChat.IServiceChat>, Client.ServiceChat.IServiceChat {
        ...
        public int Connect(string name, string pasword) {
            return base.Channel.Connect(name, pasword);
        }
        
        public System.Threading.Tasks.Task<int> ConnectAsync(string name, string pasword) {
            return base.Channel.ConnectAsync(name, pasword);
        }
        ...
        public string[] GetChatHistory(int id) {
            return base.Channel.GetChatHistory(id);
        }
        
        public System.Threading.Tasks.Task<string[]> GetChatHistoryAsync(int id) {
            return base.Channel.GetChatHistoryAsync(id);
        }
